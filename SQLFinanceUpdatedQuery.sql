...
-- Product table
create table Product(ProductId int primary key, ProductName nvarchar(max), Image varchar(max), Qty int, Description varchar(max), ProductCost decimal(10,2))
...
-- insertto in product
insert into Product values(51,'Samsung Microwave Oven','C:\Users\krith\OneDrive\Desktop\Finance\Product Images\Microwave oven',3,'28L, Black Color',43200.00)
insert into Product values(101,'iphone 12','C:\Users\krith\OneDrive\Desktop\Finance\Product Images\iphone 12',9,'128gb 6.1inch 12mpcamera ',70990.00)
insert into Product values(102,'Oneplus 9 pro 5g','C:\Users\krith\OneDrive\Desktop\Finance\Product Images\oneplus 9pro 5g',15,'Black Color 64gb 7200mah ',29890.00)
insert into Product values(201,'Mi Led tv 2c','C:\Users\krith\OneDrive\Desktop\Finance\Product Images\Mi led tv 4c',5,'led smart 52inches',31250.00)
